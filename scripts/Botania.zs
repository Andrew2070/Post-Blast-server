...
recipes.addShaped(<Botania:altar>, [[<ore:stoneAndesite>, <academy-craft:ac_Item_resoComp>, <ore:stoneAndesite>], [null, <chisel:andesite:2>, null], [<Botania:stone8Stairs>, <witchery:ingredient:11>, <Botania:stone8Stairs>]]);
recipes.addShaped(<Botania:runeAltar>, [[<ore:livingrock>, <ore:circuitUltimate>, <Botania:livingrock>], [<ore:livingrock>, <ore:manaPearl>, <Botania:livingrock>], [<ore:ingotManasteel>, <ore:ingotManasteel>, <ore:ingotManasteel>]]);
recipes.remove(<Botania:terraPlate>);
recipes.remove(<Botania:runeAltar>);


recipes.addShaped(<Botania:runeAltar>, [[<ore:livingrock>, <ore:circuitUltimate>, <ore:livingrock>], [<ore:livingrock>, <ore:manaPearl>, <ore:livingrock>], [<ore:ingotManasteel>, <ore:ingotManasteel>, <ore:ingotManasteel>]]);
