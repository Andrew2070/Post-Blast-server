...
recipes.addShaped(<Thaumcraft:ItemThaumometer>, [[<ore:shardWater>, <ore:ingotGold>, <ore:materialAspectShard>], [<ore:shardFire>, <Botania:lens>, <ore:shardAir>], [<ore:materialAspectShard>, <ore:ingotGold>, <ore:materialAspectShard>]]);
recipes.addShaped(<Thaumcraft:WandCap> * 2, [[<ore:plateIron>, <ore:plateConstraintMetal>, <ore:plateIron>], [<ore:plateIron>, <academy-craft:ac_Item_resoComp>.reuse(), <ore:plateIron>]]);
recipes.addShaped(<Thaumcraft:WandCasting>, [[null, null, <Thaumcraft:WandCap>], [null, <ore:treatedStick>, null], [<Thaumcraft:WandCap>, null, <academy-craft:ac_Block_developerAdvanced>.reuse()]]);
#Name: Thaumcraft.zs
...
mods.thaumcraft.Crucible.addRecipe("THAUMIUM", <Thaumcraft:ItemResource:2>, <ore:ingotSilver>, "praecantatio 4");
...
# -- Agglomeration Plate
mods.thaumcraft.Infusion.addRecipe("INFUSION", <minecraft:lapis_block>, [<Mekanism:ControlCircuit:3>, <Botania:manaResource:1>, <Botania:rune>, <Botania:rune:1>, <Botania:rune:2>, <Botania:rune:3>, <Botania:manaResource:1>], "perditio 32, ordo 32, potentia 32", <Botania:terraPlate>, 5);
